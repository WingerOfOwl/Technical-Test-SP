...
WebUI.click(findTestObject('Main Menu Page/Page_Swag Labs/button Remove'))

WebUI.verifyElementPresent(findTestObject('Main Menu Page/Page_Swag Labs/Button Product 1'), 0)
